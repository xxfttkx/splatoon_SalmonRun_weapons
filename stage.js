...
var curr = res.regularSchedules[0];
var stage = curr.stage.name;
var timeString = convertUtcToChinaTime(curr.start_time) + "  ~  " + convertUtcToChinaTime(curr.end_time);
console.log(stage + ": " + timeString);